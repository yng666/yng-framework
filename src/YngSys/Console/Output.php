...
use Exception;
use Yng\Console\Output\Ask;
use Yng\Console\Output\Descriptor;
use Yng\Console\Output\Driver\Buffer;
use Yng\Console\Output\Driver\Console;
use Yng\Console\Output\Driver\Nothing;
use Yng\Console\Output\Question;
use Yng\Console\Output\Question\Choice;
use Yng\Console\Output\Question\Confirmation;
use Throwable;
 ...
 * @package Yng\Console
 *
 * @see     \Yng\Console\Output\Driver\Console::setDecorated
 * @method void setDecorated($decorated)
 *
 * @see     \Yng\Console\Output\Driver\Buffer::fetch
 * @method string fetch()
 *
...
class Output
{
    ...
    {
        $class = '\\Yng\\Console\\Output\\Driver\\' . ucwords($driver);

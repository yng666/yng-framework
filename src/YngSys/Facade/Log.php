 ...
 * @method static \Yng\Log clear(string|array $channel = '*') 清空日志信息
 * @method static \Yng\Log close(string|array $channel = '*') 关闭本次请求日志写入
 * @method static array getLog(string $channel = null) 获取日志信息
 * @method static bool save() 保存日志信息
 * @method static \Yng\Log record(mixed $msg, string $type = 'info', array $context = [], bool $lazy = true) 记录日志信息
 * @method static \Yng\Log write(mixed $msg, string $type = 'info', array $context = []) 实时写入日志信息

 ...
 * @package Yng\Facade
 * @mixin \Yng\App
 * @method static \Yng\Service|null register(\Yng\Service|string $service, bool $force = false) 注册服务
 * @method static mixed bootService(\Yng\Service $service) 执行服务
 * @method static \Yng\Service|null getService(string|\Yng\Service $service) 获取服务
 * @method static \Yng\App debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \Yng\App setNamespace(string $namespace) 设置应用命名空间
 ...
 * @method static string getStoragePath() 获取应用运行时目录
 * @method static void setRuntimePath(string $path) 设置runtime目录
 * @method static string getYngPath() 获取核心框架目录
 ...
 * @method static \Yng\App initialize() 初始化应用

...
use Yng\Cache\TagSet;
use Yng\Exception\InvalidArgumentException;
use Yng\Helper\Arr;

/**
 * 缓存管理类
 * @mixin Driver
 * @mixin \Yng\Cache\Driver\File
 */
class Cache extends Manager implements CacheInterface
{

    protected $namespace = '\\Yng\\Cache\\Driver\\';
    ...
    {
        return $this->getStoreConfig($name, 'driver', 'file');
    }
     ...
     * 连接或者切换缓存
     * @access public
     * @param string|null $driver 连接配置名
     * @return Driver
     */

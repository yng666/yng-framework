...
use Closure;
use Yng\Exception\RouteNotFoundException;
use Yng\Route\Dispatch;
use Yng\Route\Dispatch\Callback;
use Yng\Route\Dispatch\Url as UrlDispatch;
use Yng\Route\Domain;
use Yng\Route\Resource;
use Yng\Route\ResourceRegister;
use Yng\Route\Rule;
...
class Route
{
    ...
    public function __construct(protected App $app)
    {
        ...
        if (is_file($this->app->getStoragePath() . 'route.php')) {
            // 读取路由映射文件
            $this->import(include $this->app->getStoragePath() . 'route.php');
        }
    ...
    protected function init()
    {
        ...
        //是否合并路由配置项赋值到类变量mergeRuleRegex中

...
use Yng\Db\Exception\DataNotFoundException;
use Yng\Db\Exception\ModelNotFoundException;
use Yng\Request;
use Yng\Response;
use Throwable;
...
class Handle
{
    ...
    protected function renderExceptionContent(Throwable $exception): string
    {
        ...
        extract($data);
        include $this->app->config->get('app.exception_tmpl') ?: __DIR__ . '/../../tpl/yng_exception.tpl';
    ...
    protected function getExtendData(Throwable $exception): array
    {
        ...
        if ($exception instanceof \Yng\Exception) {

...
use Yng\Facade\Config;
use Yng\Facade\Cookie;
use Yng\Facade\Env;
use Yng\Facade\Event;
use Yng\Facade\Lang;
use Yng\Facade\Log;
...
use Yng\Response;
use Yng\Response\File;
use Yng\Response\Json;
use Yng\Response\Jsonp;
use Yng\Response\Redirect;
use Yng\Response\View;
use Yng\Response\Xml;
use Yng\Route\Url as UrlBuild;
use Yng\Validate;
...
if (!function_exists('download')) {
    /**
     * 获取\Yng\response\Download对象实例
     * @param string $filename 要下载的文件
     * @param string $name     显示文件名
     * @param bool   $content  是否为内容
     * @param int    $expire   有效期（秒）
     * @return \Yng\response\File
     */
...
if (!function_exists('json')) {
    /**
     * 获取\Yng\response\Json对象实例
     * @param mixed $data    返回的数据
     * @param int   $code    状态码
     * @param array $header  头部
     * @param array $options 参数
     * @return \Yng\response\Json
     */
...
if (!function_exists('jsonp')) {
    /**
     * 获取\Yng\response\Jsonp对象实例
     * @param mixed $data    返回的数据
     * @param int   $code    状态码
     * @param array $header  头部
     * @param array $options 参数
     * @return \Yng\response\Jsonp
     */
...
if (!function_exists('redirect')) {
    /**
     * 获取\Yng\response\Redirect对象实例
     * @param string $url  重定向地址
     * @param int    $code 状态码
     * @return \Yng\response\Redirect
     */
...
if (!function_exists('trace')) {
     ...
     * @return array|void
     */
    function trace($log = '[Yng]', string $level = 'log')
    {
        if ('[Yng]' === $log) {
            return Log::getLog();
        }
...
if (!function_exists('xml')) {
    /**
     * 获取\Yng\response\Xml对象实例
     * @param mixed $data    返回的数据
     * @param int   $code    状态码
     * @param array $header  头部
     * @param array $options 参数
     * @return \Yng\response\Xml
     */
...
if (!function_exists('storage_path')) {
    ...
    {
        return app()->getStoragePath() . ($path ? $path . DIRECTORY_SEPARATOR : $path);
    }
}
...
if (!function_exists('resource_path')) {
    ...
    {
        return app()->getRootPath() .'resources'.DIRECTORY_SEPARATOR. ($path ? $path . DIRECTORY_SEPARATOR : $path);
    }
}

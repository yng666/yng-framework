...
<body>
    <div class="top_title">哦豁! 索命👻来找你了</div>
    <?php if (\Yng\Facade\App::isDebug()) { ?>
    ...
    <div class="copyright">
        <a title="官方网站" href="http://www.yngphp.cn">YNGPHP</a> 
        <span>V<?php echo \Yng\Facade\App::version(); ?></span> 
        <span>『优雅高性能框架』</span>
        <span>- <a title="官方手册" href="https://www.kancloud.cn/manual/Yngphp/content">官方手册</a></span>
    </div>
    <?php if (\Yng\Facade\App::isDebug()) { ?>
    <script>
